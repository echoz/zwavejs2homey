...
| driver     | `log config updated`                                    | yes                                             | backend updates UI state via socket events                      | `zwjs.event.driver` + raw-normalized     | none                                                                          | none                    | not recorded                            | P2       | Still pending specialized event typing and `driver.update_log_config` wrapper              |
