...
| driver   | `driver.firmware_update_otw`                                        |        41+ | yes              | `firmwareUpdateOTW`                                     | `generic-mutation`                                      | `protocol-native` | none                                            | no              | P3       | High-risk firmware workflow mutation pending dedicated wrappers |
