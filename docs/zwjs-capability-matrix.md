...
| controller | `controller.get_known_lifeline_routes`                              |                                 varies | source command enum/docs family                   | route/health maintenance workflows                                  | `typed-wrapper` (`getControllerKnownLifelineRoutes`)                           | `partial`         | `fixture`, `mocked-transport`                                    | no              | P3       | Advanced controller diagnostics read wrapper added; live validation pending     |
| controller | `controller.get_rf_region`                                          |                                 varies | source command enum/docs family                   | RF region management workflows                                      | `typed-wrapper` (`getControllerRfRegion`)                                      | `partial`         | `fixture`, `mocked-transport`                                    | no              | P3       | Read-only controller RF diagnostics wrapper added                               |
| controller | `controller.get_powerlevel`                                         |                                 varies | source command enum/docs family                   | powerlevel diagnostics workflows                                    | `typed-wrapper` (`getControllerPowerlevel`)                                    | `partial`         | `fixture`, `mocked-transport`                                    | no              | P3       | Read-only powerlevel diagnostics wrapper added                                  |
| controller | `controller.get_max_long_range_powerlevel`                          |                                 varies | source command enum/docs family                   | long-range diagnostics workflows                                    | `typed-wrapper` (`getControllerMaxLongRangePowerlevel`)                        | `partial`         | `fixture`, `mocked-transport`                                    | no              | P3       | Long-range diagnostics wrapper added                                            |
| controller | `controller.get_long_range_channel`                                 |                                 varies | source command enum/docs family                   | long-range diagnostics workflows                                    | `typed-wrapper` (`getControllerLongRangeChannel`)                              | `partial`         | `fixture`, `mocked-transport`                                    | no              | P3       | Long-range channel diagnostics wrapper added                                    |
