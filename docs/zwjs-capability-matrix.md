...
| driver   | `driver.firmware_update_otw`                                        |        41+ | yes              | `firmwareUpdateOTW`                                     | `typed-wrapper` (`driverFirmwareUpdateOtw`)             | `protocol-native` | `fixture`, `mocked-transport` (policy path)     | no              | P3       | High-risk firmware mutation wrapper is policy-gated; live validation deferred |
