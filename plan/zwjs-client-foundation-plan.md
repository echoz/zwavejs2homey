...
14. [x] Validate expanded command/event coverage against real instance (read-only only)
15. [x] Add mutating-command layer (still protocol-oriented) with safety guards (separate phase)
