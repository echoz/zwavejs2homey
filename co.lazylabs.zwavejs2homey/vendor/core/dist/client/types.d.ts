...
export type ZwjsLifecycleState = 'idle' | 'connecting' | 'connected' | 'reconnecting' | 'stopping' | 'stopped' | 'error';
...
export type ZwjsControllerNodeNeighborsResult = number[] | {
    neighbors?: number[];
    [key: string]: unknown;
};
...
export type ZwjsDefinedValueIdsResult = ZwjsDefinedValueId[] | {
    values?: ZwjsDefinedValueId[];
    [key: string]: unknown;
};
...
export type ZwjsNodeValueResult = string | number | boolean | null | ZwjsNodeValueEnvelopeResult | Array<unknown>;
...
export type ZwjsDriverFirmwareUpdateOtwArgs = ZwjsDriverFirmwareUpdateOtwRawFileArgs | ZwjsDriverFirmwareUpdateOtwUpdateInfoArgs;
...
export type ZwjsEndpointSupportsCcApiResult = boolean | {
    supported?: boolean;
    [key: string]: unknown;
};
export type ZwjsEndpointSupportsCcResult = boolean | {
    supported?: boolean;
    [key: string]: unknown;
};
export type ZwjsEndpointControlsCcResult = boolean | {
    controls?: boolean;
    [key: string]: unknown;
};
export type ZwjsEndpointIsCcSecureResult = boolean | {
    secure?: boolean;
    [key: string]: unknown;
};
export type ZwjsEndpointGetCcVersionResult = number | {
    version?: number;
    [key: string]: unknown;
};
...
export type ZwjsVirtualEndpointEndpointCountResult = number | {
    count?: number;
    [key: string]: unknown;
};
export type ZwjsVirtualEndpointSupportsCcResult = boolean | {
    supported?: boolean;
    [key: string]: unknown;
};
export type ZwjsVirtualEndpointSupportsCcApiResult = boolean | {
    supported?: boolean;
    [key: string]: unknown;
};
export type ZwjsVirtualEndpointGetCcVersionResult = number | {
    version?: number;
    [key: string]: unknown;
};
export type ZwjsVirtualEndpointDefinedValueIdsResult = ZwjsDefinedValueIdsResult;
export type ZwjsInvokeCcApiResult = Record<string, unknown> | Array<unknown> | string | number | boolean | null;
...
export interface ZwjsEventBase {
    type: 'client.lifecycle' | 'client.reconnect.scheduled' | 'transport.connected' | 'transport.disconnected' | 'auth.succeeded' | 'auth.failed' | 'compat.warning' | 'protocol.error' | 'server.info' | 'nodes.snapshot' | 'zwjs.event.driver' | 'zwjs.event.controller' | 'zwjs.event.node' | 'zwjs.event.zniffer' | 'zwjs.event.node.value-updated' | 'zwjs.event.node.value-added' | 'zwjs.event.node.value-removed' | 'zwjs.event.node.value-notification' | 'zwjs.event.node.metadata-updated' | 'zwjs.event.node.notification' | 'zwjs.event.node.wake-up' | 'zwjs.event.node.sleep' | 'zwjs.event.node.interview-started' | 'zwjs.event.node.interview-completed' | 'zwjs.event.node.interview-failed' | 'zwjs.event.node.interview-stage-completed' | 'zwjs.event.driver.logging' | 'zwjs.event.driver.log-config-updated' | 'zwjs.event.driver.firmware-update-progress' | 'zwjs.event.driver.firmware-update-finished' | 'zwjs.event.controller.grant-security-classes' | 'zwjs.event.controller.validate-dsk-and-enter-pin' | 'zwjs.event.controller.inclusion-aborted' | 'zwjs.event.controller.nvm-backup-progress' | 'zwjs.event.controller.nvm-convert-progress' | 'zwjs.event.controller.nvm-restore-progress' | 'zwjs.event.controller.firmware-update-progress' | 'zwjs.event.controller.firmware-update-finished' | 'zwjs.event.zniffer.ready' | 'zwjs.event.zniffer.corrupted-frame' | 'zwjs.event.zniffer.frame' | 'zwjs.event.zniffer.error' | 'zwjs.event.node.test-powerlevel-progress' | 'zwjs.event.node.check-lifeline-health-progress' | 'zwjs.event.node.check-route-health-progress' | 'zwjs.event.node.firmware-update-progress' | 'zwjs.event.node.firmware-update-finished' | 'node.event.raw-normalized';
    ts: string;
    source: 'zwjs-client';
}
export type ZwjsClientEvent = (ZwjsEventBase & {
    type: 'client.lifecycle';
    from: ZwjsLifecycleState;
    to: ZwjsLifecycleState;
}) | (ZwjsEventBase & {
    ...
    type: 'zwjs.event.controller';
    event: ZwjsProtocolEventPayload;
}) | (ZwjsEventBase & {
    type: 'zwjs.event.node';
    event: ZwjsProtocolEventPayload;
}) | (ZwjsEventBase & {
    type: 'zwjs.event.zniffer';
    event: ZwjsProtocolEventPayload;
}) | (ZwjsEventBase & {
    ...
    event: ZwjsNodeValueAddedEventPayload;
}) | (ZwjsEventBase & {
    ...
    event: ZwjsNodeWakeUpEventPayload;
}) | (ZwjsEventBase & {
    type: 'zwjs.event.node.sleep';
    event: ZwjsNodeSleepEventPayload;
}) | (ZwjsEventBase & {
    ...
    event: ZwjsDriverLoggingEventPayload;
}) | (ZwjsEventBase & {
...
export type ZwjsClientEventInput = ZwjsClientEvent extends infer T ? T extends {
    ts: string;
    source: 'zwjs-client';
} ? Omit<T, 'ts' | 'source'> : never : never;
