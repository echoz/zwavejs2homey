...
import type { HomeyInboundMapping, HomeyOutboundMapping, ProvenanceLayer } from '../models/homey-plan';
...
export type RuleAction = CapabilityRuleAction | DeviceIdentityRuleAction | IgnoreValueRuleAction | RemoveCapabilityRuleAction;
