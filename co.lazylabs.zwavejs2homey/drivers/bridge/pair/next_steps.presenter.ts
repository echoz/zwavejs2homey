...
interface BridgeNextStepsPresenter {
...
interface UiRoot {
  Zwjs2HomeyUi?: {
    bridgeNextStepsPresenter?: BridgeNextStepsPresenter;
  };
}

(function attachNextStepsPresenter(
  root: UiRoot | undefined,
  factory: () => BridgeNextStepsPresenter,
) {
  ...
  nextRoot.Zwjs2HomeyUi.bridgeNextStepsPresenter = presenter;
})(
