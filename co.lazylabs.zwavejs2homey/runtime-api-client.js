...
function assertApiFacade(homeyApi) {
  if (!homeyApi || typeof homeyApi !== 'object' || typeof homeyApi.api !== 'function') {
    throw new RuntimeApiClientError(
      'invalid-homey-api',
...
function parseEnvelope(envelope) {
  ...
  if (envelope.schemaVersion !== API_SCHEMA_VERSION) {
    throw new RuntimeApiClientError(
      'invalid-envelope',
      `Unexpected route schemaVersion: ${String(envelope.schemaVersion)}`,
    );
  }
  if (envelope.ok === true) {
